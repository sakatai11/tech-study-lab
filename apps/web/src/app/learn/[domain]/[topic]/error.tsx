  ...
  return (
    <div className="min-h-dvh bg-bg px-4 py-8">
      <main className="mx-auto max-w-3xl">
        <TermCrumb command="content --check" />
        <Card className="mt-5 border-red p-6 sm:p-8">
          <p className="m-0 font-mono text-xs font-bold text-red">error: lesson_load_failed</p>
          <h1 className="mb-0 mt-3 text-2xl font-black text-ink">教材を読み込めませんでした</h1>
